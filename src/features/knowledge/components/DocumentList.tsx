...
export function DocumentList() {
  ...
  if (!docs || docs.length === 0) {
    return (
      <p className="rounded-xl border border-line bg-bg px-4 py-6 text-center text-sm text-muted">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {doc.status !== 'approved' && (
                <button
                  ...
                  className="rounded-lg bg-primary px-3 py-1.5 text-xs font-semibold text-primary-ink disabled:opacity-50"
                >
                  Freigeben
                </button>
              )}
              {doc.status === 'approved' && (
                <button
                  ...
                  disabled={setStatus.isPending}
                  className="rounded-lg border border-line px-3 py-1.5 text-xs font-medium text-ink disabled:opacity-50"
                >
                  Archivieren
                </button>
              )}
              <button
                ...
                className="rounded-lg px-3 py-1.5 text-xs font-medium text-muted hover:text-red-700 disabled:opacity-50"
              >
                Löschen
              </button>
            </div>
