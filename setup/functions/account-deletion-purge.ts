// AscendOS Edge Function: account-deletion-purge (Dashboard-Version, alles in einer Datei)
// Name der Function MUSS exakt lauten: account-deletion-purge
//
// GENERIERT von scripts/bundle-functions.mjs — NICHT von Hand ändern.
// Quelle: supabase/functions/account-deletion-purge/index.ts
