...
-- ############ 20260818000031_genealogy_org_root_view.sql ############
-- ============================================================
...
-- ############ 20260819000032_content_assistant_foundation.sql ############
-- ============================================================
-- Migration 32: AI Content Assistant foundation (ADDITIVE ONLY)
--
-- NEW tables + private storage bucket + quota helpers.
-- Does NOT alter coach, contacts, team, AP, profiles, chats, or sync schemas.
--
-- Decisions (product):
--   - All advisors upload personal assets; content managers may add central assets
--   - Bucket private; delivery via signed URLs only
--   - Separate content quota via organizations.settings.content_asset_limit (default 25)
--   - Instagram OAuth/publish architecture tables without storing passwords/tokens yet
--   - Daily preparation rows targeted for 12:00 local job (edge/cron later)
-- ============================================================

-- ---------- Org setting default (jsonb merge; no column change on organizations) ---
...
-- ############ 20260820000033_content_assistant_foundation_standalone.sql ############
-- ============================================================
...
-- ############ 20260821000034_meta_data_deletion_requests.sql ############
...
-- ############ 20260822000035_content_publish_attempts_idempotency.sql ############
...
-- ############ 20260824000037_content_drafts_instagram_audio_json.sql ############
...
-- ############ 20260825000038_content_facebook_business_connections.sql ############
...
-- ############ 20260826000039_content_drafts_carousel.sql ############
-- ============================================================
...
-- ############ 20260827000040_content_autopilot.sql ############
-- ============================================================
...
-- ############ 20260828000041_live_coaching_web_push_production.sql ############
...
-- ############ 20260829000042_content_asset_library_limit_50.sql ############
...
-- ############ 20260830000043_platform_admins_and_org_role_helpers.sql ############
-- ============================================================
...
-- ############ 20260831000044_phase3_tenant_org_columns.sql ############
-- ============================================================
...
-- ############ 20260901000045_phase4_rls_tenant_isolation.sql ############
-- ============================================================
...
-- ############ 20260904000048_phase8_org1_branding_guide.sql ############
...
-- ############ 20260907000051_phase11_billing_usage.sql ############
-- ============================================================
...
-- ############ 20260912000056_knowledge_pdf_vision.sql ############
-- ============================================================
...
-- ############ 20260913000057_team_radar_startpoint.sql ############
-- ============================================================
...
-- ############ 20260914000058_radar_discovery_hourly_cron.sql ############
...
-- ############ 20260915000059_account_pending_deletion.sql ############
...
-- ############ 20260916000060_glossily_readiness_foundation.sql ############
-- ============================================================
...
-- ############ 20260917000061_autopilot_publishing_modes.sql ############
-- ============================================================
...
-- ############ 20260918000062_radar_source_chogan_beauty.sql ############
-- ============================================================
